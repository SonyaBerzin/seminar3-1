...
Для того, что бы связать локальный репозиторий с удаленным, необходимо выполнить следующие действия:
Создать удаленный репозиторий на платформе, например, на GitHub или Bitbucket.
...
Выполнить команду git push -u origin master. Это отправит изменения в удаленный репозиторий и свяжет ветку master локального репозитория с веткой master удаленного репозитория.
